...
func TestImageExists(t *testing.T) {
	...
	image := NewDockerComposeImage("mcr.microsoft.com/dotnet/samples", "latest", "sha256:test", "", logger, cancelCtx, cancelFunc)
	assert.False(t, image.Exists())

	image = NewDockerComposeImage("mcr.microsoft.com/dotnet/samples", "latest", "sha256:d41fe80991d7c26ad43b052bb87c68a216a365c143623a62b5a5963fcdb77eb1", "", logger, cancelCtx, cancelFunc)
...
func TestIsRunning(t *testing.T) {
	...
	image := NewDockerComposeImage("ubuntu", "latest", "sha256:2b7412e6465c3c7fc5bb21d3e6f1917c167358449fecac8176c6e496e5c1f05f", "", logger, cancelCtx, cancelFunc)
	if !image.Exists() {
